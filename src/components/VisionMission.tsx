        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 lg:gap-12 mb-10 md:mb-12 lg:mb-16">
            <Card className="p-6 md:p-8 bg-muted border-border animate-slide-in-left">
              ...
              <h3 className="text-2xl md:text-3xl font-serif font-bold mb-3 md:mb-4 text-card-foreground">Our Vision</h3>
            ...
            <Card className="p-6 md:p-8 bg-muted border-border animate-slide-in-right">
              ...
              <h3 className="text-2xl md:text-3xl font-serif font-bold mb-3 md:mb-4 text-card-foreground">Our Mission</h3>
              <p className="text-base md:text-lg text-muted-foreground leading-relaxed">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 md:gap-6">
            {values.map((value, index) => (
              <Card
                key={index}
                className="p-4 md:p-6 bg-background border-border text-center hover:bg-muted transition-all duration-300 group animate-scale-in"
