          ...
          <div className="flex items-center justify-between py-3">
            ...
            <Link to="/" className="flex items-center gap-3 group">
              <img
                ...
                alt="MKU CU Logo"
                className="w-10 h-10 md:w-12 md:h-12 object-contain transition-transform group-hover:scale-105" src="/lovable-uploads/d7e39077-9fab-48b2-a966-23d29d0ec2ff.png" />
